...
restaurant1 = Restaurant(RestaurantName='The Famous Curry Bazaar', Address_Line_1='77 Brick Lane', City='London', Postcode='E1 6QL', Telephone='02073751986', Opening_Hours='Monday to Sunday, 12pm to 12am',Cuisine='Indian', Price='£26 - £40')
db.session.add(restaurant1)
restaurant2 = Restaurant(RestaurantName='Orient London', Address_Line_1='15 Wardour Street', City='London', Postcode='W1D 6PH', Telephone='02079898880', Opening_Hours='Monday to Sunday, 11am to 11pm', Cuisine='Chinese', Price='£26 - £40')
...
restaurant7 = Restaurant(RestaurantName='Wahaca Covent Garden', Address_Line_1='66 Chandos Place', City='London', Postcode='WC2N 4HG', Telephone='020 3951 9741', Opening_Hours='Monday to Sunday, 12pm to 10pm', Cuisine= 'Mexican', Price='£26 - £40')
