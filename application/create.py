...
db.session.commit(restaurant10)
...
db.session.commit(restaurant11)
...
db.session.commit(restaurant12)
restaurant13 = Restaurant(RestaurantName='Shi Fu Chinese Restaurant', Address_Line_1='142 West Cromwell Road', City='London', Postcode='W14 9AE', Telephone='020 7610 4333', Opening_Hours='Monday - Sunday: 12pm - 11pm', Cuisine='Chinese', Price='£25 & under')
db.session.add(restaurant13)
db.session.commit(restaurant13)
...
db.session.commit(restaurant14)
...
db.session.commit(restaurant15)
...
db.session.commit(restaurant16)
...
db.session.commit(restaurant17)
...
db.session.commit(restaurant18)
...
db.session.commit(restaurant19)
