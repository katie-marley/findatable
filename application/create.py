...
restaurant1 = Restaurant(RestaurantName='The Famous Curry Bazaar', Address_Line_1='77 Brick Lane', City='London', Postcode='E1 6QL', Telephone='020 7375 1986', Opening_Hours='Monday - Sunday: 12pm - 12am',Cuisine='Indian', Price='£26 - £40')
db.session.add(restaurant1)
restaurant2 = Restaurant(RestaurantName='Orient London', Address_Line_1='15 Wardour Street', City='London', Postcode='W1D 6PH', Telephone='020 7989 8880', Opening_Hours='Monday - Sunday: 11am - 11pm', Cuisine='Chinese', Price='£26 - £40')
...
restaurant4 = Restaurant(RestaurantName='Tarboush', Address_Line_1='57 Market Street', City='Watford', Postcode='WD18 0PR', Telephone='01923 248 898', Opening_Hours='Monday - Sunday: 11am - 12am', Cuisine='Lebanese', Price='£25 & under')
db.session.add(restaurant4)
restaurant5 = Restaurant(RestaurantName='Umu Restaurant', Address_Line_1='14-16 Bruton Place', City='London', Postcode='W1 6LX', Telephone='020 7499 8881', Opening_Hours='Monday - Sunday: 12pm - 2 pm & 6pm - 10pm', Cuisine='Japanese', Price='£41 & over')
db.session.add(restaurant5)
restaurant6 = Restaurant(RestaurantName='Ella Canta', Address_Line_1='1 Hambleton Place', City='London', Postcode='W1J 7QI', Telephone='020 7318 8715', Opening_Hours='Monday - Sunday: 12pm - 12am', Cuisine='Mexican', Price='£41 and over')
db.session.add(restaurant6)
restaurant7 = Restaurant(RestaurantName='Wahaca Covent Garden', Address_Line_1='66 Chandos Place', City='London', Postcode='WC2N 4HG', Telephone='020 3951 9741', Opening_Hours='Monday - Sunday: 12pm to 10pm', Cuisine='Mexican', Price='£26 - £40')
